...
public class TodolistApplication {
	...
	CommandLineRunner criarTarefasFake(TodoRepository todoRepository){
		return args -> {
			...
			Todo todo2 = new Todo("Estidar Java", "Estudar Java para aprender programação", StatusEnum.IN_PROGRESS);
			Todo todo3 = new Todo("Estudar HTML","Estudar HTML para desenvolvimento dites", StatusEnum.FINISHED);
